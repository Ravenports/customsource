--- storage/rocksdb/ha_rocksdb.cc.orig	2020-03-25 10:13:18 UTC
...
@@ -5760,7 +5760,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5867,7 +5867,7 @@ static int rocksdb_done_func(void *const
